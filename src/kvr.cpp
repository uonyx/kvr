...
kvr::sz_t kvr::value::map::trucap () const
{
...
void kvr::stream::put (uint8_t byte)
{
  KVR_ASSERT (m_bytes);
...
void kvr::stream::set_eos (uint8_t eos)
{
  KVR_ASSERT (m_pos < m_cap);
  m_bytes [m_pos] = eos;
}
