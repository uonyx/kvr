...
////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////
// a simple memory tracking allocator using malloc. 


class memtrack_allocator : public kvr::allocator
{
public:
  ...
  // constructor
  memtrack_allocator () : m_alloc_count (0), m_free_count (0), m_bytes_allocated (0), m_bytes_freed (0) {}

  // stats
  size_t get_allocation_count ()    { return m_alloc_count; }
  size_t get_deallocation_count ()  { return m_free_count; }
  size_t get_memory_malloc ()       { return m_bytes_allocated; }
  size_t get_memory_freed ()        { return m_bytes_freed; }

  int64_t get_memory_usage ()        
  { 
    return (int64_t) m_bytes_allocated - (int64_t) m_bytes_freed;
  }
